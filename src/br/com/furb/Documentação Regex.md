...
* Match em String que se iniciam com os caracteres(case sensitive/acento sensitive): Á, B, D, G . É usado para saber quando estamos tratando com um possível Combustível 
# isValueRegex - ^R\\$;
