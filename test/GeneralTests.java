...
public class GeneralTests {
    ...
    public void testValidGeneral1() {
        ...
        ex.process("1.2 403 2014 2.153 R$44.000,00 Bicombustível 2015 Álcool Diesel 1.5 Bicombustível R$2,00");
    ...
    public void testValidGeneral2() {
        ExpressionValidator ex = new ExpressionValidator();
        ex.process("1.2               2018 R$47.500,00 0              Bicombustível R$125.900,00 6.990 Diesel 1.4 R$23.800,00 Gasolina Álcool");
        int qtyFuel = ex.getQtyFuel();
        int qtyYear = ex.getQtyYear();
        int qtyEngine = ex.getQtyEngine();
        int qtyValue = ex.getQtyValue();
    ...
    public void testValidGeneral3() {
        ExpressionValidator ex = new ExpressionValidator();
        ex.process("1.0 2018 R$47.500,00 0 Bicombustível R$125.900,00 6.990 Diesel 1.4 R$23.800,00 Gasolina Álcool");
        int qtyFuel = ex.getQtyFuel();
        int qtyYear = ex.getQtyYear();
        int qtyEngine = ex.getQtyEngine();
        int qtyValue = ex.getQtyValue();
